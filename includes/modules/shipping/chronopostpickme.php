...
class chronopostpickme extends base {
  ...
  function getStores() {
    global $db;
    $res = $db->Execute('select * from chronopost_pickme_shops');
    return $res;
  }
...
chronopostpickme = {
  ...
  buildSelect : function() {
    ...
    select += '<select onchange="chronopostpickme.saveStore();" id="chronopostpickme_store" name="chronopostpickme_store">';
